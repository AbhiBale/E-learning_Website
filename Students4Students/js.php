...
<body>
    <div id="main">
        ...
        <ul id="menu">
		  ...
		  <li><a>                                     </a></li>
		  <li><a>                                     </a></li>
          <li><h4><u><a a href="logout.php"> <img src="logout.jpg" alt="Logout" width="40" height="40" style="vertical-align:middle;margin:-25px 5px"> <?php echo $_SESSION['username']; ?></a></u></h4></li>
        </ul>
      </div>
    </div>
    <div id="site_content">
        ...
        <div id="content">
            <h1 id="01">&#128488; Javascript Tutorial</h1>
